<x-layouts.app title="Campaigns" heading="Campaigns">
    <div class="campaign-hero">
        <div><p class="campaign-eyebrow">Your outbox, organized</p><h2 class="text-2xl font-bold">Messages that make a connection</h2><p class="mt-2 text-sm">Create your next campaign, pick up a draft, or review delivery results.</p></div>
    ...
    <section class="campaign-directory overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div class="campaign-directory-heading"><div><h2 class="font-semibold">All campaigns</h2><p class="text-xs text-slate-500">Drafts and delivery history in one place.</p></div><span class="settings-state">{{ number_format($campaigns->total()) }} campaigns</span></div>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($campaigns as $campaign)
                        <tr class="hover:bg-slate-50/70" data-status="{{ $campaign->status }}">
