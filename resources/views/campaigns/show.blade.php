<x-layouts.app title="Campaign Report" heading="Campaign report">
    <div class="campaign-workspace campaign-report">
    ...
    <div class="campaign-layout mt-6">
        <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="campaign-directory-heading"><div><h3 class="font-semibold">Delivery results</h3><p class="mt-1 text-xs text-slate-500">Latest recorded result for each recipient.</p></div></div>
        ...
        <aside class="space-y-6">
            ...
            <details class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"><summary class="font-semibold">View original message</summary><p class="mt-3 text-sm font-semibold">{{ $campaign->subject }}</p><p class="campaign-message mt-2 text-sm text-slate-600">{{ $campaign->body }}</p></details>
        </aside>
    </div>
    </div>
@if (session('start_sending'))
